...
public class AppArgsDefinition {
	...
	public void addOption(String commandName, String optionName, int index, String optionDescription, boolean mandatory, boolean hasValue, String defaultValue) {
		addOption(commandName, optionName, index, optionDescription, mandatory, hasValue, null, defaultValue);
	}
	
	public void addSelectionValueOption(String commandName, String optionName, int index, String optionDescription, boolean mandatory, String[] selectionValues, String defaultValue) {
		addOption(commandName, optionName, index, optionDescription, mandatory, true, selectionValues, defaultValue);
	}
	
	protected void addOption(String commandName, String optionName, int index, String optionDescription, boolean mandatory, boolean hasValue, String[] selectionValues, String defaultValue){
	...
	public void addSubOption(String commandName, String parentOptionName,  String optionName, String optionDescription, boolean mandatory, boolean hasValue, String[] selectionValues, String defaultValue) {
		Map<String, OptionDef> optMap = defMap.get(commandName);
		if(optMap == null){
			optMap = new HashMap<String, OptionDef>();
			defMap.put(commandName, optMap);
